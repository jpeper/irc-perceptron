...
def calculate_predictions(weights, testing_list, compiled_dictionary, linked_pairs):
    ...
    for k in range(0, len(testing_list), 2):
        print("Working on file " + str(k//2 + 1) + " of " + str(len(testing_list)//2))
...
def generate_annotation_file(weights, benchmark_list, compiled_dictionary, linked_pairs):
    ...
    for k in range(0, len(benchmark_list), 2):
        ...
        output_file_name = benchmark_list[k] + ".annotated.perceptron"
...
if __name__ == "__main__":          
    ...
    print("creating compiled dictionary")
    ...
    print("number of reduced linked pairs is " + str(len(linked_pairs)))
    ...
    print("\nRunning perceptron with best testing weights on benchmark files:")
